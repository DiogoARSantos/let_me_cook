...
class _AddRecipeScreenState extends State<AddRecipeScreen> {
        ...
        body: Form(
            ...
            child: ListView(
                children: [Column(
                    children: <Widget>[
                      //PAGE TITLE
                      Text('Criar Nova Receita', style: TextStyle(
                      ...
                      Row(
                          ...
                          children: [
                            Text('Número de porções:   ', style: TextStyle(
                      ...
                      Align(
                        ...
                        child: Text("Ingredientes", style: TextStyle(
                            fontSize: 22, fontWeight: FontWeight.bold)),
                      ),
                      ...
                      Align(
                        alignment: Alignment(-0.9, 0),
                        child: Text("Passos", style: TextStyle(
                            fontSize: 22, fontWeight: FontWeight.bold)),
                      ),
  ...
  void _createRecipe() {
    if (_formKey.currentState != null && _formKey.currentState!.validate()) {
      ...
      for (int i = 0; i < _ingredientsItems.length; i++) {
        Ingredient igt = Ingredient(name: _ingredientsItems[i].text,
