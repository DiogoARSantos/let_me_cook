...
List<Recipe> startRecipeList = [
  Recipe(
    ...
    ingredients: [
      ...
      Ingredient(name: "Ovos", quantity: 2, units: "unid."),
  ...
  Recipe(
    ...
    ingredients: [
      ...
      Ingredient(name: "Cebola", quantity: 1, units: "unid."),
  ...
  Recipe(
    ...
    duration: 60,
    ingredients: [
      Ingredient(name: "Frango inteiro", quantity: 1, units: "unid."),
  ...
  Recipe(
    ...
    duration: 15,
    ingredients: [
      Ingredient(name: "Alface", quantity: 1, units: "unid."),
      Ingredient(name: "Peito de Frango", quantity: 200, units: "g"),
      ...
      Ingredient(name: "Azeite", quantity: 2, units: "colheres de sopa"),
      Ingredient(name: "Limão", quantity: 1, units: "unid."),
    ],
    steps: [
  ...
  Recipe(
    ...
    duration: 45,
    ingredients: [
      Ingredient(name: "Cenoura", quantity: 3, units: "unid."),
      Ingredient(name: "Batatas", quantity: 2, units: "unid."),
      Ingredient(name: "Cebola", quantity: 1, units: "unid."),
      Ingredient(name: "Alho", quantity: 1, units: "unid."),
      Ingredient(name: "Caldo de legumes", quantity: 1, units: "litro"),
      Ingredient(name: "Tomate", quantity: 2, units: "unid."),
      Ingredient(name: "Azeite", quantity: 2, units: "colheres de sopa"),
      Ingredient(name: "Sal", quantity: 1, units: "colher de chá"),
    ...
    steps: [
      ...
      "Refogue as cebolas e o alho até ficarem macios.",
  ...
  Recipe(
    ...
    duration: 35,
    ingredients: [
      Ingredient(name: "Peito de frango", quantity: 500, units: "g"),
      Ingredient(name: "Tortilhas de milho", quantity: 8, units: "unid."),
      Ingredient(name: "Alface", quantity: 1, units: "unid."),
      Ingredient(name: "Tomate", quantity: 2, units: "unid."),
      ...
      Ingredient(name: "Coentros", quantity: 2, units: "colheres de sopa"),
    ],
    steps: [
      ...
      "Polvilhe coentros picados por cima e sirva.",
    ],
  ),
  Recipe(
